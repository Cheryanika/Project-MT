    ...
    const fn = async () => {
      ...
      if (!JSON.stringify(data).match("error")) {
        await Promise.all(promises).then((data) => {
          ...
          for (i = 0; i < data.length; i++) {
            textArea.value +=
              data[i][0].generated_text.replaceAll("▁", "") + " ";
          }
        });
      } else {
        setTimeout(() => {
      ...
      <div>
        ...
        >
          <table>
            <tr>
              <th>
                <img src={image} weight={82} height={150} alt={image}></img>
              </th>
              <th className="text-light">
                แปลภาษาบทคัดย่อภาษาไทย - อังกฤษ
                <br />
              ...
              <br />
              <select
                className="form-select position-absolute right-0 end-0 translate-middle"
                id="lange_text"
        ...
        <div className="container">
          ...
          <p className="text-dark" style={{ fontSize: 25 }}>
            {" "}
            <label className="form-label" id="lange_text1">
              {showtext}
            </label>
          </p>
          <nav
        ...
        <div className="container">
          ...
          <p className="text-dark" style={{ fontSize: 25 }}>
            {" "}
            <label className="form-label" id="lange_text2">
              {showtext1}
            </label>
          </p>
          <div
        ...
        <table className="container credit">
          ...
          <tr>
            <th className="credit_pad" style={{ fontSize: 18 }}>
              {" "}
              เกี่ยวกับเว็บไซต์{" "}
            </th>
            <th className="credit_pad" style={{ fontSize: 18 }}>
              {" "}
              วิธีใช้งานและคำแนะนำ{" "}
            </th>
            <th className="credit_pad" style={{ fontSize: 18 }}>
              {" "}
          ...
          <tr>
            <th className="credit-text-1" style={{ fontSize: 15 }}>
              ระบบแปลภาษาสำหรับบทคัดย่อบทความทางวิชาการภาษาไทย-อังกฤษด้วยแบบจำลอง
              Deep Neural Machine Translation
              ฝึกด้วยชุดข้อมูลบทคัดย่อภาษาไทย-อังกฤษซึ่งรวบรวมมาจากวารสารทางวิศวกรรมที่ตีพิมพ์บน
              <a href="https://www.tci-thaijo.org/">&nbsp;ThaiJO&nbsp;</a>
              จำนวน 1,125 บทความในขณะนี้รองรับ 3 แบบจำลองได้แก่
            ...
            <th className="credit-text-2" style={{ fontSize: 15 }}>
              <br />
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1.
              กรอกบทคัดย่อในกล่องข้อความจากนั้นเลือกภาษาที่จะแปล
              <br />
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;โดยมีให้เลือกระหว่าง TH-EN และ
              EN-TH และเลือก Machine
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Translation และกดแปลภาษา
              <br />
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2.
              ในการแปลครั้งแรกจะต้องรอประมาณ 5 - 10 นาที
              <br />
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3.
              บทคัดย่อควรมียาวประมาณไม่เกิน 10 ประโยค
              <br />
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;4.
              หากพบข้อผิดพลาดใดๆสามารถแจ้งปัญหาได้ทาง
              <br />
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              ...
              <button className="btn-custom btn-sm">
                <a className="a-2" href={howtouse} download={"HowToUseWebsite"}>
                  คู่มือการใช้งาน
                </a>
              </button>
              <br />
            ...
            <th className="credit-text-1" style={{ fontSize: 15 }}>
              ...
              เชียงใหม่ จัดทำโดย นายนครินทร์ คมลาย และนางสาวเฌอญานิกา วงค์ตาแก้ว
              ซึ่งพัฒนาโดยใช้ Google Colab Pro ในการฝึกแบบจำลองใช้{" "}
              <a href="https://wandb.ai/home">Weights & Bias</a>
              &nbsp;ในการติดตามผลการฝึกแบบจำลอง
